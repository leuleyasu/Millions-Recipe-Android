...
import 'package:flutter_application_4/common/constants.dart';
import 'package:flutter_application_4/providers/recipe_provider.dart';
import 'package:flutter_application_4/screens/detail_screen.dart';
import 'package:flutter_application_4/common/shared.dart';
...
class _HomeState extends State<Home> {
  ...
  String category = "Popular Category";
      ...
      body: ListView(
        ...
        children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        buildCalories("${recipeProvider.recipes[index]
                                                .nutritions[0]
                                                .value}  ${recipeProvider.recipes[index].nutritions[0].unit}"),
                                        const Icon(
          ...
          Padding(
            ...
            child: TextButton(onPressed: (){}, child: Text('See all ->',style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold),),),
          ),
